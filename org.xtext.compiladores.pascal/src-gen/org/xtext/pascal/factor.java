 ...
 *   <li>{@link org.xtext.pascal.factor#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.xtext.pascal.factor#getNot <em>Not</em>}</li>
 * </ul>
 *
 * @see org.xtext.pascal.PascalPackage#getfactor()
 * @model
 * @generated
 */
public interface factor extends EObject
{
   ...
   * @see org.xtext.pascal.PascalPackage#getfactor_Variable()
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getVariable <em>Variable</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getfactor_Number()
   * @model containment="true"
   * @generated
   */
  number getNumber();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getNumber <em>Number</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getfactor_String()
   * @model
   * @generated
   */
  String getString();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getString <em>String</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setNil(boolean)
   * @see org.xtext.pascal.PascalPackage#getfactor_Nil()
   * @model
   * @generated
   */
  boolean isNil();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#isNil <em>Nil</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getfactor_Boolean()
   * @model
   * @generated
   */
  String getBoolean();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getBoolean <em>Boolean</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getfactor_Function()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getFunction <em>Function</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getfactor_Expression()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getExpression <em>Expression</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setNot(factor)
   * @see org.xtext.pascal.PascalPackage#getfactor_Not()
   * @model containment="true"
   * @generated
   */
  factor getNot();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.factor#getNot <em>Not</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
