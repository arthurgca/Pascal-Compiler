 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.pascal.impl.array_typeImpl#getIndexes <em>Indexes</em>}</li>
 *   <li>{@link org.xtext.pascal.impl.array_typeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class array_typeImpl extends MinimalEObjectImpl.Container implements array_type
{
  ...
  public EList<index_type> getIndexes()
  {
    if (indexes == null)
    {
      indexes = new EObjectContainmentEList<index_type>(index_type.class, this, PascalPackage.ARRAY_TYPE__INDEXES);
    }
    return indexes;
  }
