 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.pascal.impl.record_sectionImpl#getIdentifiers <em>Identifiers</em>}</li>
 *   <li>{@link org.xtext.pascal.impl.record_sectionImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class record_sectionImpl extends MinimalEObjectImpl.Container implements record_section
{
  ...
  public NotificationChain basicSetIdentifiers(identifier_list newIdentifiers, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PascalPackage.RECORD_SECTION__IDENTIFIERS, oldIdentifiers, newIdentifiers);
  ...
  public void setIdentifiers(identifier_list newIdentifiers)
  {
    if (newIdentifiers != identifiers)
    {
      ...
      if (identifiers != null)
        msgs = ((InternalEObject)identifiers).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PascalPackage.RECORD_SECTION__IDENTIFIERS, null, msgs);
      if (newIdentifiers != null)
        msgs = ((InternalEObject)newIdentifiers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PascalPackage.RECORD_SECTION__IDENTIFIERS, null, msgs);
      msgs = basicSetIdentifiers(newIdentifiers, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PascalPackage.RECORD_SECTION__IDENTIFIERS, newIdentifiers, newIdentifiers));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PascalPackage.RECORD_SECTION__IDENTIFIERS:
