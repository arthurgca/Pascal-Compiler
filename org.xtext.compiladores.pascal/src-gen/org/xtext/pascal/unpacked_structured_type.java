 ...
 * </ul>
 *
 * @see org.xtext.pascal.PascalPackage#getunpacked_structured_type()
 * @model
 * @generated
 */
public interface unpacked_structured_type extends EObject
{
   ...
   * @see org.xtext.pascal.PascalPackage#getunpacked_structured_type_Array()
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.unpacked_structured_type#getArray <em>Array</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getunpacked_structured_type_Dynamic()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.unpacked_structured_type#getDynamic <em>Dynamic</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setSet(set_type)
   * @see org.xtext.pascal.PascalPackage#getunpacked_structured_type_Set()
   * @model containment="true"
   * @generated
   */
  set_type getSet();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.unpacked_structured_type#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.pascal.PascalPackage#getunpacked_structured_type_File()
   * @model containment="true"
   * @generated
   */
  file_type getFile();
  ...
  /**
   * Sets the value of the '{@link org.xtext.pascal.unpacked_structured_type#getFile <em>File</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
