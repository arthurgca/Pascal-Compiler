...
import org.xtext.ide.contentassist.antlr.internal.InternalPascalParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVar_Access().getAlternatives(), "rule__Var___Alternatives");
					...
					put(grammarAccess.getVar_Access().getGroup_0(), "rule__Var___Group_0__0");
					put(grammarAccess.getVar_Access().getGroup_1(), "rule__Var___Group_1__0");
					put(grammarAccess.getVar_Access().getGroup_2(), "rule__Var___Group_2__0");
					...
					put(grammarAccess.getProgram_heading_blockAccess().getNameAssignment_1(), "rule__Program_heading_block__NameAssignment_1");
					put(grammarAccess.getProgram_heading_blockAccess().getIdentifiersAssignment_2_1(), "rule__Program_heading_block__IdentifiersAssignment_2_1");
					put(grammarAccess.getIdentifier_listAccess().getNamesAssignment_0(), "rule__Identifier_list__NamesAssignment_0");
					put(grammarAccess.getIdentifier_listAccess().getNamesAssignment_1_1(), "rule__Identifier_list__NamesAssignment_1_1");
					put(grammarAccess.getBlockAccess().getLabelAssignment_0(), "rule__Block__LabelAssignment_0");
					put(grammarAccess.getBlockAccess().getConstantAssignment_1(), "rule__Block__ConstantAssignment_1");
					put(grammarAccess.getBlockAccess().getTypeAssignment_2(), "rule__Block__TypeAssignment_2");
					put(grammarAccess.getBlockAccess().getVariableAssignment_3(), "rule__Block__VariableAssignment_3");
					put(grammarAccess.getBlockAccess().getAbstractionAssignment_4(), "rule__Block__AbstractionAssignment_4");
					put(grammarAccess.getBlockAccess().getStatementAssignment_5(), "rule__Block__StatementAssignment_5");
					...
					put(grammarAccess.getSimple_statementAccess().getFunction_noargsAssignment_3(), "rule__Simple_statement__Function_noargsAssignment_3");
					...
					put(grammarAccess.getFactorAccess().getBooleanAssignment_6(), "rule__Factor__BooleanAssignment_6");
					put(grammarAccess.getFactorAccess().getFunctionAssignment_7(), "rule__Factor__FunctionAssignment_7");
					put(grammarAccess.getFactorAccess().getExpressionAssignment_8_1(), "rule__Factor__ExpressionAssignment_8_1");
					put(grammarAccess.getFactorAccess().getNotAssignment_9_1(), "rule__Factor__NotAssignment_9_1");
					...
					put(grammarAccess.getStructured_statementAccess().getWithStmtAssignment_3(), "rule__Structured_statement__WithStmtAssignment_3");
					put(grammarAccess.getCompound_statementAccess().getSequenceAssignment_1(), "rule__Compound_statement__SequenceAssignment_1");
					put(grammarAccess.getRepetitive_statementAccess().getWhileStmtAssignment_0(), "rule__Repetitive_statement__WhileStmtAssignment_0");
					put(grammarAccess.getRepetitive_statementAccess().getRepeatStmtAssignment_1(), "rule__Repetitive_statement__RepeatStmtAssignment_1");
					put(grammarAccess.getRepetitive_statementAccess().getForStmtAssignment_2(), "rule__Repetitive_statement__ForStmtAssignment_2");
					...
					put(grammarAccess.getRepeat_statementAccess().getSequenceAssignment_1(), "rule__Repeat_statement__SequenceAssignment_1");
					put(grammarAccess.getRepeat_statementAccess().getExpressionAssignment_3(), "rule__Repeat_statement__ExpressionAssignment_3");
					put(grammarAccess.getFor_statementAccess().getAssignmentAssignment_1(), "rule__For_statement__AssignmentAssignment_1");
					put(grammarAccess.getFor_statementAccess().getExpressionAssignment_3(), "rule__For_statement__ExpressionAssignment_3");
					put(grammarAccess.getFor_statementAccess().getStatementAssignment_5(), "rule__For_statement__StatementAssignment_5");
					...
					put(grammarAccess.getCase_statementAccess().getCasesAssignment_3(), "rule__Case_statement__CasesAssignment_3");
					put(grammarAccess.getCase_statementAccess().getCasesAssignment_4_1(), "rule__Case_statement__CasesAssignment_4_1");
					put(grammarAccess.getCase_limbAccess().getCasesAssignment_0(), "rule__Case_limb__CasesAssignment_0");
					...
					put(grammarAccess.getUnpacked_structured_typeAccess().getDynamicAssignment_1(), "rule__Unpacked_structured_type__DynamicAssignment_1");
					put(grammarAccess.getUnpacked_structured_typeAccess().getRecordAssignment_2(), "rule__Unpacked_structured_type__RecordAssignment_2");
					put(grammarAccess.getUnpacked_structured_typeAccess().getSetAssignment_3(), "rule__Unpacked_structured_type__SetAssignment_3");
					put(grammarAccess.getUnpacked_structured_typeAccess().getFileAssignment_4(), "rule__Unpacked_structured_type__FileAssignment_4");
					...
					put(grammarAccess.getDynamic_array_typeAccess().getTypeAssignment_2(), "rule__Dynamic_array_type__TypeAssignment_2");
					put(grammarAccess.getIndex_typeAccess().getTypeAssignment(), "rule__Index_type__TypeAssignment");
					put(grammarAccess.getRecord_typeAccess().getRecordKeywordAssignment_0(), "rule__Record_type__RecordKeywordAssignment_0");
					put(grammarAccess.getRecord_typeAccess().getFieldsAssignment_1(), "rule__Record_type__FieldsAssignment_1");
					put(grammarAccess.getRecord_typeAccess().getEndKeywordAssignment_2(), "rule__Record_type__EndKeywordAssignment_2");
					...
					put(grammarAccess.getParameter_typeAccess().getArrayAssignment_0(), "rule__Parameter_type__ArrayAssignment_0");
					put(grammarAccess.getParameter_typeAccess().getNameAssignment_1(), "rule__Parameter_type__NameAssignment_1");
					...
					put(grammarAccess.getBound_specificationAccess().getInitialAssignment_0(), "rule__Bound_specification__InitialAssignment_0");
					put(grammarAccess.getBound_specificationAccess().getFinalAssignment_2(), "rule__Bound_specification__FinalAssignment_2");
